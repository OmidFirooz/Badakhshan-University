...
if($_SERVER['REQUEST_METHOD']=="POST"){
    ...
    $sql = "INSERT INTO teacher(FirstName,LastName,DateOfBirth,Gender,HireDate,Email,PhoneNumber,Department,Photo) VALUES 
    ('$firstName','$lastName','$dOfBirth','$gender','$hireDate','$email','$phoneNo','$department','$photo')";
...
<div class="container mt-5">
    <?php 
        $query_read = 'SELECT * FROM teacher';
    ...
    <div class="custom-form-container">
        ...
        <form action="<?php htmlspecialchars($_SERVER['PHP_SELF']) ?>" method='POST' class="row justify-content-center">
            <div class="custom-form-group">
                ...
                <label for="faculty" class="custom-form-label">Hire Date</label>
                <input class="form-control" type="date" name="hireDate" class="form-control custom-input" required>
